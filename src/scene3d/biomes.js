...
const BIOMES = {
  ...
  'verdant-maw': {
    name: 'Verdant Maw',
    ground:        '#3e6b3a',     // brighter sunlit jungle floor
    groundEdge:    '#6a4828',     // warmer wood/earth bevel
    grid:          '#88b06a',
    gridAccent:    '#c8e088',
    fog:           '#1c2e18',
    fogDensity:    0.018,         // half the previous density — let it breathe
    keyLight:      '#fff0c0',
    rimLight:      '#7fc8ff',
    ambient:       '#bcdcff',
    ambientGround: '#4a5c2e',
    particle:      '#dfffc8',
  },
  'razorback-canopy': {
